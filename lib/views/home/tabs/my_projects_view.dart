  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder.reactive(
      ...
      builder: (context, viewModel, child) {
        return Scaffold(
            body: FutureBuilder(
                future: viewModel.getMyProjects(context: context),
                      ...
                      child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ProjectCard(
                              ...
                              showOwnerName: false,
                              onViewTasks: () {
                                viewModel.navigateToProjectView(project.id!,
                                    project.users, project.ownerUid);
                              },
                              onViewDetail: () {
            ...
            floatingActionButton: FloatingActionButton(
                onPressed: () async {
                  await locator<NavigationService>()
                      .navigateTo(Routes.addProjectView);
                  viewModel.rebuildUi();
                },
